...
```
## declare components
```{r declare-components, echo=echo_chunks, results='show',warning=warning_chunks, message=message_chunks}
```
...
# concluding remarks
 ...
 - Frameworks are like toothbrushes: everyone’s got them, but no-one wants to use anyone else’s. [source](https://twitter.com/trishgreenhalgh/status/891674763285942272)
...
- Automate the choice of pallete for any number of colors
